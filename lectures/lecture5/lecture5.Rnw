...
\begin{itemize}
	...
	\item Purpose to measure college readiness
	  \begin{itemize}
	    \item def'n: College readiness benchmark associated with a 65\% probability of earning a first-year GPA of 2.67 or higher.
	  \end{itemize}
...
\begin{itemize}
	...
	\item \textcolor{RoyalBlue}{How can we assume this is measuring the construct of aggression quantitatively?}
		\begin{itemize}
			\item Experts assess whether each item is essential, useful, not necessary to the definition of aggression
